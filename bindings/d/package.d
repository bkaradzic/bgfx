...
enum CapFlags: CapFlags_{
	...
	fragmentBarycentric     = 0x0000_0000_0000_0080, ///Fragment barycentric coordinates are available in fragment shader.
	...
	rendererMultithreaded   = 0x0000_0000_0000_8000, ///Renderer is on separate thread.
	swapChain               = 0x0000_0000_0001_0000, ///Multiple windows are supported.
	texture2DArray          = 0x0000_0000_0002_0000, ///2D texture array is supported.
	texture3D               = 0x0000_0000_0004_0000, ///3D textures are supported.
	textureBlit             = 0x0000_0000_0008_0000, ///Texture blit is supported.
	transparentBackbuffer   = 0x0000_0000_0010_0000, ///Transparent back buffer supported.
	textureCompareReserved  = 0x0000_0000_0020_0000,
	textureCompareLEqual    = 0x0000_0000_0040_0000, ///Texture compare less equal mode is supported.
	textureCubeArray        = 0x0000_0000_0080_0000, ///Cubemap texture array is supported.
	textureDirectAccess     = 0x0000_0000_0100_0000, ///CPU direct access to GPU texture memory.
	textureReadBack         = 0x0000_0000_0200_0000, ///Read-back texture is supported.
	vertexAttribHalf        = 0x0000_0000_0400_0000, ///Vertex attribute half-float is supported.
	vertexAttribUint10      = 0x0000_0000_0800_0000, ///Vertex attribute 10_10_10_2 is supported.
	vertexID                = 0x0000_0000_1000_0000, ///Rendering with VertexID only is supported.
	primitiveID             = 0x0000_0000_2000_0000, ///PrimitiveID is available in fragment shader.
	viewportLayerArray      = 0x0000_0000_4000_0000, ///Viewport layer is available in vertex shader.
	drawIndirectCount       = 0x0000_0000_8000_0000, ///Draw indirect with indirect count is supported.
	textureCompareAll       = 0x0000_0000_0060_0000, ///All texture compare modes are supported.
}
