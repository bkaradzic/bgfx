...
#	endif // BX_PLATFORM_
	...
	struct Context
	{
			...
			, m_scrollPos(0.0f)
		{
			...
			s_translateKey[GLFW_KEY_KP_ENTER]      = Key::Return;
			...
			s_translateKey[GLFW_KEY_INSERT]        = Key::Insert;
			s_translateKey[GLFW_KEY_DELETE]        = Key::Delete;
			...
			s_translateKey[GLFW_KEY_LEFT_BRACKET]  = Key::LeftBracket;
			s_translateKey[GLFW_KEY_RIGHT_BRACKET] = Key::RightBracket;
			s_translateKey[GLFW_KEY_SEMICOLON]     = Key::Semicolon;
			s_translateKey[GLFW_KEY_APOSTROPHE]    = Key::Quote;
			s_translateKey[GLFW_KEY_COMMA]         = Key::Comma;
			s_translateKey[GLFW_KEY_PERIOD]        = Key::Period;
			s_translateKey[GLFW_KEY_KP_DECIMAL]    = Key::Period;
			s_translateKey[GLFW_KEY_SLASH]         = Key::Slash;
			s_translateKey[GLFW_KEY_KP_DIVIDE]     = Key::Slash;
			s_translateKey[GLFW_KEY_BACKSLASH]     = Key::Backslash;
			s_translateKey[GLFW_KEY_GRAVE_ACCENT]  = Key::Tilde;
