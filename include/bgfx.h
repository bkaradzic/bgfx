...
namespace bgfx
{
	...
	struct VertexDecl
	{
		BGFX_SHARED_LIB_API VertexDecl();

		/// Start VertexDecl.
		BGFX_SHARED_LIB_API VertexDecl& begin(RendererType::Enum _renderer = RendererType::Null);

		/// End VertexDecl.
		BGFX_SHARED_LIB_API void end();
		...
		///
		BGFX_SHARED_LIB_API VertexDecl& add(Attrib::Enum _attrib, uint8_t _num, AttribType::Enum _type, bool _normalized = false, bool _asInt = false);

		/// Skip _num bytes in vertex stream.
		BGFX_SHARED_LIB_API VertexDecl& skip(uint8_t _num);

		/// Decode attribute.
		BGFX_SHARED_LIB_API void decode(Attrib::Enum _attrib, uint8_t& _num, AttribType::Enum& _type, bool& _normalized, bool& _asInt) const;

		/// Returns true if VertexDecl contains attribute.
		BGFX_SHARED_LIB_API bool has(Attrib::Enum _attrib) const { return 0xff != m_attributes[_attrib]; }

		/// Returns relative attribute offset from the vertex.
		BGFX_SHARED_LIB_API uint16_t getOffset(Attrib::Enum _attrib) const { return m_offset[_attrib]; }

		/// Returns vertex stride.
		BGFX_SHARED_LIB_API uint16_t getStride() const { return m_stride; }

		/// Returns size of vertex buffer for number of vertices.
		BGFX_SHARED_LIB_API uint32_t getSize(uint32_t _num) const { return _num*m_stride; }
	...
	BGFX_SHARED_LIB_API void vertexPack(const float _input[4], bool _inputNormalized, Attrib::Enum _attr, const VertexDecl& _decl, void* _data, uint32_t _index = 0);

	/// Unpack vec4 from vertex stream format.
	BGFX_SHARED_LIB_API void vertexUnpack(float _output[4], Attrib::Enum _attr, const VertexDecl& _decl, const void* _data, uint32_t _index = 0);
	...
	///
	BGFX_SHARED_LIB_API void vertexConvert(const VertexDecl& _destDecl, void* _destData, const VertexDecl& _srcDecl, const void* _srcData, uint32_t _num = 1);
	...
	///
	BGFX_SHARED_LIB_API uint16_t weldVertices(uint16_t* _output, const VertexDecl& _decl, const void* _data, uint16_t _num, float _epsilon = 0.001f);
	...
	///
	BGFX_SHARED_LIB_API void imageSwizzleBgra8(uint32_t _width, uint32_t _height, uint32_t _pitch, const void* _src, void* _dst);
	...
	///
	BGFX_SHARED_LIB_API void imageRgba8Downsample2x2(uint32_t _width, uint32_t _height, uint32_t _pitch, const void* _src, void* _dst);
	...
	///
	BGFX_SHARED_LIB_API void init(RendererType::Enum _type = RendererType::Count, uint16_t _vendorId = BGFX_PCI_ID_NONE, uint16_t _deviceId = 0, CallbackI* _callback = NULL, bx::ReallocatorI* _reallocator = NULL);
	...
	///
	BGFX_SHARED_LIB_API uint32_t frame();
	...
	///
	BGFX_SHARED_LIB_API const Memory* makeRef(const void* _data, uint32_t _size, ReleaseFn _releaseFn = NULL, void* _userData = NULL);
	...
	///
	BGFX_SHARED_LIB_API void dbgTextImage(uint16_t _x, uint16_t _y, uint16_t _width, uint16_t _height, const void* _data, uint16_t _pitch);
	...
	///
	BGFX_SHARED_LIB_API VertexBufferHandle createVertexBuffer(const Memory* _mem, const VertexDecl& _decl, uint16_t _flags = BGFX_BUFFER_NONE);
	...
	///
	BGFX_SHARED_LIB_API DynamicIndexBufferHandle createDynamicIndexBuffer(uint32_t _num, uint16_t _flags = BGFX_BUFFER_NONE);
	...
	///
	BGFX_SHARED_LIB_API DynamicIndexBufferHandle createDynamicIndexBuffer(const Memory* _mem, uint16_t _flags = BGFX_BUFFER_NONE);
	...
	///
	BGFX_SHARED_LIB_API void updateDynamicIndexBuffer(DynamicIndexBufferHandle _handle, const Memory* _mem);
	...
	///
	BGFX_SHARED_LIB_API DynamicVertexBufferHandle createDynamicVertexBuffer(uint32_t _num, const VertexDecl& _decl, uint16_t _flags = BGFX_BUFFER_NONE);
	...
	///
	BGFX_SHARED_LIB_API DynamicVertexBufferHandle createDynamicVertexBuffer(const Memory* _mem, const VertexDecl& _decl, uint16_t _flags = BGFX_BUFFER_NONE);
...
/// @param _handle Dynamic vertex buffer handle.
	...
	///
	BGFX_SHARED_LIB_API bool checkAvailTransientBuffers(uint32_t _numVertices, const VertexDecl& _decl, uint32_t _numIndices);
	...
	///
	BGFX_SHARED_LIB_API void allocTransientVertexBuffer(TransientVertexBuffer* _tvb, uint32_t _num, const VertexDecl& _decl);
	...
	///
	BGFX_SHARED_LIB_API bool allocTransientBuffers(TransientVertexBuffer* _tvb, const VertexDecl& _decl, uint32_t _numVertices, TransientIndexBuffer* _tib, uint32_t _numIndices);
	...
	///
	BGFX_SHARED_LIB_API uint16_t getShaderUniforms(ShaderHandle _handle, UniformHandle* _uniforms = NULL, uint16_t _max = 0);
	...
	///
	BGFX_SHARED_LIB_API ProgramHandle createProgram(ShaderHandle _vsh, ShaderHandle _fsh, bool _destroyShaders = false);
	...
	///
	BGFX_SHARED_LIB_API ProgramHandle createProgram(ShaderHandle _csh, bool _destroyShader = false);
	...
	///
	BGFX_SHARED_LIB_API void calcTextureSize(TextureInfo& _info, uint16_t _width, uint16_t _height, uint16_t _depth, bool _cubeMap, uint8_t _numMips, TextureFormat::Enum _format);
	...
	///
	BGFX_SHARED_LIB_API TextureHandle createTexture(const Memory* _mem, uint32_t _flags = BGFX_TEXTURE_NONE, uint8_t _skip = 0, TextureInfo* _info = NULL);
	...
	///
	BGFX_SHARED_LIB_API TextureHandle createTexture2D(uint16_t _width, uint16_t _height, uint8_t _numMips, TextureFormat::Enum _format, uint32_t _flags = BGFX_TEXTURE_NONE, const Memory* _mem = NULL);

	///
	/// @attention C99 equivalent is `bgfx_create_texture_2d_scaled`.
	///
	BGFX_SHARED_LIB_API TextureHandle createTexture2D(BackbufferRatio::Enum _ratio, uint8_t _numMips, TextureFormat::Enum _format, uint32_t _flags = BGFX_TEXTURE_NONE);
	...
	///
	BGFX_SHARED_LIB_API TextureHandle createTexture3D(uint16_t _width, uint16_t _height, uint16_t _depth, uint8_t _numMips, TextureFormat::Enum _format, uint32_t _flags = BGFX_TEXTURE_NONE, const Memory* _mem = NULL);
	...
	///
	BGFX_SHARED_LIB_API TextureHandle createTextureCube(uint16_t _size, uint8_t _numMips, TextureFormat::Enum _format, uint32_t _flags = BGFX_TEXTURE_NONE, const Memory* _mem = NULL);
	...
	///
	BGFX_SHARED_LIB_API void updateTexture2D(TextureHandle _handle, uint8_t _mip, uint16_t _x, uint16_t _y, uint16_t _width, uint16_t _height, const Memory* _mem, uint16_t _pitch = UINT16_MAX);
	...
	///
	BGFX_SHARED_LIB_API void updateTexture3D(TextureHandle _handle, uint8_t _mip, uint16_t _x, uint16_t _y, uint16_t _z, uint16_t _width, uint16_t _height, uint16_t _depth, const Memory* _mem);
	...
	///
	BGFX_SHARED_LIB_API void updateTextureCube(TextureHandle _handle, uint8_t _side, uint8_t _mip, uint16_t _x, uint16_t _y, uint16_t _width, uint16_t _height, const Memory* _mem, uint16_t _pitch = UINT16_MAX);
	...
	///
	BGFX_SHARED_LIB_API FrameBufferHandle createFrameBuffer(uint16_t _width, uint16_t _height, TextureFormat::Enum _format, uint32_t _textureFlags = BGFX_TEXTURE_U_CLAMP | BGFX_TEXTURE_V_CLAMP);

	///
	/// @attention C99 equivalent is `bgfx_create_frame_buffer_scaled`.
	///
	BGFX_SHARED_LIB_API FrameBufferHandle createFrameBuffer(BackbufferRatio::Enum _ratio, TextureFormat::Enum _format, uint32_t _textureFlags = BGFX_TEXTURE_U_CLAMP | BGFX_TEXTURE_V_CLAMP);
	...
	///
	BGFX_SHARED_LIB_API FrameBufferHandle createFrameBuffer(uint8_t _num, TextureHandle* _handles, bool _destroyTextures = false);
	...
	///
	BGFX_SHARED_LIB_API FrameBufferHandle createFrameBuffer(void* _nwh, uint16_t _width, uint16_t _height, TextureFormat::Enum _depthFormat = TextureFormat::UnknownDepth);
	...
	///
	BGFX_SHARED_LIB_API void setClearColor(uint8_t _index, uint32_t _rgba);
	...
	/// @attention C99 equivalent is ``.
	///
	BGFX_SHARED_LIB_API void setClearColor(uint8_t _index, float _r, float _g, float _b, float _a);
	...
	///
	BGFX_SHARED_LIB_API void setClearColor(uint8_t _index, const float _rgba[4]);
	...
	///
	BGFX_SHARED_LIB_API void setViewScissor(uint8_t _id, uint16_t _x = 0, uint16_t _y = 0, uint16_t _width = 0, uint16_t _height = 0);
	...
	///
	BGFX_SHARED_LIB_API void setViewClear(uint8_t _id, uint16_t _flags, uint32_t _rgba = 0x000000ff, float _depth = 1.0f, uint8_t _stencil = 0);
	...
	///
	BGFX_SHARED_LIB_API void setViewClear(uint8_t _id, uint16_t _flags, float _depth, uint8_t _stencil, uint8_t _0 = UINT8_MAX, uint8_t _1 = UINT8_MAX, uint8_t _2 = UINT8_MAX, uint8_t _3 = UINT8_MAX, uint8_t _4 = UINT8_MAX, uint8_t _5 = UINT8_MAX, uint8_t _6 = UINT8_MAX, uint8_t _7 = UINT8_MAX);
	...
	///
	BGFX_SHARED_LIB_API void setViewTransform(uint8_t _id, const void* _view, const void* _projL, uint8_t _flags = BGFX_VIEW_STEREO, const void* _projR = NULL);
	...
	///
	BGFX_SHARED_LIB_API void setIndexBuffer(IndexBufferHandle _handle, uint32_t _firstIndex = 0, uint32_t _numIndices = UINT32_MAX);

	/// Set index buffer for draw primitive.
	///
	/// @attention C99 equivalent is `bgfx_set_dynamic_index_buffer`.
	///
	BGFX_SHARED_LIB_API void setIndexBuffer(DynamicIndexBufferHandle _handle, uint32_t _firstIndex = 0, uint32_t _numIndices = UINT32_MAX);
	...
	///
	BGFX_SHARED_LIB_API void setIndexBuffer(const TransientIndexBuffer* _tib, uint32_t _firstIndex, uint32_t _numIndices);
	...
	///
	BGFX_SHARED_LIB_API void setVertexBuffer(DynamicVertexBufferHandle _handle, uint32_t _numVertices = UINT32_MAX);
	...
	///
	BGFX_SHARED_LIB_API void setVertexBuffer(const TransientVertexBuffer* _tvb, uint32_t _startVertex, uint32_t _numVertices);
	...
	///
	BGFX_SHARED_LIB_API void setInstanceDataBuffer(DynamicVertexBufferHandle _handle, uint32_t _startVertex, uint32_t _num);

	/// Set program for draw primitive.
	///
	/// @attention C99 equivalent is `bgfx_set_program`.
	///
	BGFX_SHARED_LIB_API void setProgram(ProgramHandle _handle);
	...
	///
	BGFX_SHARED_LIB_API void setTexture(uint8_t _stage, UniformHandle _sampler, TextureHandle _handle, uint32_t _flags = UINT32_MAX);
	...
	///
	BGFX_SHARED_LIB_API void setTexture(uint8_t _stage, UniformHandle _sampler, FrameBufferHandle _handle, uint8_t _attachment = 0, uint32_t _flags = UINT32_MAX);
	...
	///
	BGFX_SHARED_LIB_API uint32_t submit(uint8_t _id, int32_t _depth = 0);
	...
	///
	BGFX_SHARED_LIB_API uint32_t submit(uint8_t _id, IndirectBufferHandle _indirectHandle, uint16_t _start = 0, uint16_t _num = 1, int32_t _depth = 0);
	...
	///
	BGFX_SHARED_LIB_API void setImage(uint8_t _stage, UniformHandle _sampler, TextureHandle _handle, uint8_t _mip, Access::Enum _access, TextureFormat::Enum _format = TextureFormat::Count);

	/// Set compute image from frame buffer texture.
	///
	/// @attention C99 equivalent is `bgfx_set_image_from_frame_buffer`.
	///
	BGFX_SHARED_LIB_API void setImage(uint8_t _stage, UniformHandle _sampler, FrameBufferHandle _handle, uint8_t _attachment, Access::Enum _access, TextureFormat::Enum _format = TextureFormat::Count);

	/// Dispatch compute.
	///
	/// @attention C99 equivalent is `bgfx_dispatch`.
	///
	BGFX_SHARED_LIB_API uint32_t dispatch(uint8_t _id, ProgramHandle _handle, uint16_t _numX = 1, uint16_t _numY = 1, uint16_t _numZ = 1, uint8_t _flags = BGFX_SUBMIT_EYE_FIRST);

	/// Dispatch compute indirect.
	///
	/// @attention C99 equivalent is `bgfx_dispatch_indirect`.
	///
	BGFX_SHARED_LIB_API uint32_t dispatch(uint8_t _id, ProgramHandle _handle, IndirectBufferHandle _indirectHandle, uint16_t _start = 0, uint16_t _num = 1, uint8_t _flags = BGFX_SUBMIT_EYE_FIRST);
