...
namespace bgfx
{
	...
	struct Encoder
	{
		...
		/// @param[in] _dstIndex Write index in the destination buffer in bytes
		/// @param[in] _srcIndex Read index in the source buffer in bytes
		...
		void blit(
			...
			, uint32_t _dstIndex = 0
			, uint32_t _srcIndex = 0
