...
namespace bgfx
{
	...
	///
	struct BGFX_SHARED_LIB_API VertexDecl
	{
		VertexDecl();
	...
	///
	BGFX_SHARED_LIB_API void vertexPack(
	...
	///
	BGFX_SHARED_LIB_API void vertexUnpack(
		  float _output[4]
		, Attrib::Enum _attr
		, const VertexDecl& _decl
		, const void* _data
	...
	///
	BGFX_SHARED_LIB_API void vertexConvert(
	...
	///
	BGFX_SHARED_LIB_API uint16_t weldVertices(
		  uint16_t* _output
		, const VertexDecl& _decl
		, const void* _data
		, uint16_t _num
	...
	///
	BGFX_SHARED_LIB_API uint32_t topologyConvert(
	...
	///
	BGFX_SHARED_LIB_API void imageSwizzleBgra8(
		  uint32_t _width
		, uint32_t _height
		, uint32_t _pitch
		, const void* _src
	...
	///
	BGFX_SHARED_LIB_API void imageRgba8Downsample2x2(
		  uint32_t _width
		, uint32_t _height
		, uint32_t _pitch
		, const void* _src
	...
	///
	BGFX_SHARED_LIB_API uint8_t getSupportedRenderers(RendererType::Enum _enum[RendererType::Count]);

	/// Returns name of renderer.
	///
	/// @attention C99 equivalent is `bgfx_get_renderer_name`.
	///
	BGFX_SHARED_LIB_API const char* getRendererName(RendererType::Enum _type);
	...
	///
	BGFX_SHARED_LIB_API void shutdown();
	...
	///
	BGFX_SHARED_LIB_API void reset(uint32_t _width, uint32_t _height, uint32_t _flags = BGFX_RESET_NONE);
	...
	///
	BGFX_SHARED_LIB_API uint32_t frame(bool _capture = false);
	...
	///
	BGFX_SHARED_LIB_API RendererType::Enum getRendererType();
	...
	///
	BGFX_SHARED_LIB_API const Caps* getCaps();
	...
	///
	BGFX_SHARED_LIB_API const Stats* getStats();

	/// Allocate buffer to pass to bgfx calls. Data will be freed inside bgfx.
	///
	/// @attention C99 equivalent is `bgfx_alloc`.
	///
	BGFX_SHARED_LIB_API const Memory* alloc(uint32_t _size);

	/// Allocate buffer and copy data into it. Data will be freed inside bgfx.
	///
	/// @attention C99 equivalent is `bgfx_copy`.
	///
	BGFX_SHARED_LIB_API const Memory* copy(const void* _data, uint32_t _size);
	...
	///
	BGFX_SHARED_LIB_API const Memory* makeRef(
		  const void* _data
		, uint32_t _size
	...
	///
	BGFX_SHARED_LIB_API void setDebug(uint32_t _debug);

	/// Clear internal debug text buffer.
	///
	/// @attention C99 equivalent is `bgfx_dbg_text_clear`.
	///
	BGFX_SHARED_LIB_API void dbgTextClear(uint8_t _attr = 0, bool _small = false);

	/// Print into internal debug text buffer.
	///
	/// @attention C99 equivalent is `bgfx_dbg_text_printf`.
	///
	BGFX_SHARED_LIB_API void dbgTextPrintf(uint16_t _x, uint16_t _y, uint8_t _attr, const char* _format, ...);
	...
	///
	BGFX_SHARED_LIB_API void dbgTextImage(
		  uint16_t _x
		, uint16_t _y
		, uint16_t _width
		, uint16_t _height
	...
	///
	BGFX_SHARED_LIB_API IndexBufferHandle createIndexBuffer(const Memory* _mem, uint16_t _flags = BGFX_BUFFER_NONE);

	/// Destroy static index buffer.
	///
	/// @attention C99 equivalent is `bgfx_destroy_index_buffer`.
	///
	BGFX_SHARED_LIB_API void destroyIndexBuffer(IndexBufferHandle _handle);
	...
	///
	BGFX_SHARED_LIB_API VertexBufferHandle createVertexBuffer(
		  const Memory* _mem
		, const VertexDecl& _decl
	...
	///
	BGFX_SHARED_LIB_API void destroyVertexBuffer(VertexBufferHandle _handle);
	...
	///
	BGFX_SHARED_LIB_API DynamicIndexBufferHandle createDynamicIndexBuffer(
		  uint32_t _num
		, uint16_t _flags = BGFX_BUFFER_NONE
		);
	...
	///
	BGFX_SHARED_LIB_API void updateDynamicIndexBuffer(
	...
	///
	BGFX_SHARED_LIB_API void destroyDynamicIndexBuffer(DynamicIndexBufferHandle _handle);
	...
	///
	BGFX_SHARED_LIB_API DynamicVertexBufferHandle createDynamicVertexBuffer(
		  uint32_t _num
		, const VertexDecl& _decl
		, uint16_t _flags = BGFX_BUFFER_NONE
		);
	...
	///
	BGFX_SHARED_LIB_API void updateDynamicVertexBuffer(
	...
	///
	BGFX_SHARED_LIB_API void destroyDynamicVertexBuffer(DynamicVertexBufferHandle _handle);
	...
	///
	BGFX_SHARED_LIB_API bool checkAvailTransientIndexBuffer(uint32_t _num);
	...
	///
	BGFX_SHARED_LIB_API bool checkAvailTransientVertexBuffer(uint32_t _num, const VertexDecl& _decl);
	...
	///
	BGFX_SHARED_LIB_API bool checkAvailInstanceDataBuffer(uint32_t _num, uint16_t _stride);
	...
	///
	BGFX_SHARED_LIB_API bool checkAvailTransientBuffers(
	...
	///
	BGFX_SHARED_LIB_API void allocTransientIndexBuffer(TransientIndexBuffer* _tib, uint32_t _num);
	...
	///
	BGFX_SHARED_LIB_API void allocTransientVertexBuffer(TransientVertexBuffer* _tvb
		, uint32_t _num
		, const VertexDecl& _decl
		);
	...
	///
	BGFX_SHARED_LIB_API bool allocTransientBuffers(TransientVertexBuffer* _tvb
		, const VertexDecl& _decl
		, uint32_t _numVertices
	...
	///
	BGFX_SHARED_LIB_API const InstanceDataBuffer* allocInstanceDataBuffer(uint32_t _num, uint16_t _stride);

	/// Create draw indirect buffer.
	///
	/// @attention C99 equivalent is `bgfx_create_indirect_buffer`.
	///
	BGFX_SHARED_LIB_API IndirectBufferHandle createIndirectBuffer(uint32_t _num);

	/// Destroy draw indirect buffer.
	///
	/// @attention C99 equivalent is `bgfx_destroy_indirect_buffer`.
	///
	BGFX_SHARED_LIB_API void destroyIndirectBuffer(IndirectBufferHandle _handle);

	/// Create shader from memory buffer.
	///
	/// @attention C99 equivalent is `bgfx_create_shader`.
	///
	BGFX_SHARED_LIB_API ShaderHandle createShader(const Memory* _mem);
	...
	///
	BGFX_SHARED_LIB_API uint16_t getShaderUniforms(
	...
	///
	BGFX_SHARED_LIB_API void destroyShader(ShaderHandle _handle);
	...
	///
	BGFX_SHARED_LIB_API ProgramHandle createProgram(
		  ShaderHandle _vsh
		, ShaderHandle _fsh
	...
	///
	BGFX_SHARED_LIB_API void destroyProgram(ProgramHandle _handle);

	/// Calculate amount of memory required for texture.
	///
	/// @attention C99 equivalent is `bgfx_calc_texture_size`.
	///
	BGFX_SHARED_LIB_API void calcTextureSize(
		  TextureInfo& _info
		, uint16_t _width
		, uint16_t _height
		, uint16_t _depth
	...
	///
	BGFX_SHARED_LIB_API TextureHandle createTexture(
		  const Memory* _mem
	...
	///
	BGFX_SHARED_LIB_API TextureHandle createTexture2D(
		  uint16_t _width
		, uint16_t _height
		, uint8_t _numMips
		, TextureFormat::Enum _format
	...
	///
	BGFX_SHARED_LIB_API TextureHandle createTexture3D(
		  uint16_t _width
		, uint16_t _height
		, uint16_t _depth
		, uint8_t _numMips
	...
	///
	BGFX_SHARED_LIB_API TextureHandle createTextureCube(
		  uint16_t _size
		, uint8_t _numMips
		, TextureFormat::Enum _format
		, uint32_t _flags = BGFX_TEXTURE_NONE
	...
	///
	BGFX_SHARED_LIB_API void updateTexture2D(
	...
	///
	BGFX_SHARED_LIB_API void updateTexture3D(
		  TextureHandle _handle
		, uint8_t _mip
		, uint16_t _x
		, uint16_t _y
	...
	///
	BGFX_SHARED_LIB_API void updateTextureCube(
		  TextureHandle _handle
		, uint8_t _side
		, uint8_t _mip
		, uint16_t _x
	...
	///
	BGFX_SHARED_LIB_API uint32_t readTexture(TextureHandle _handle, void* _data);
	...
	///
	BGFX_SHARED_LIB_API uint32_t readTexture(FrameBufferHandle _handle, uint8_t _attachment, void* _data);
	...
	///
	BGFX_SHARED_LIB_API void destroyTexture(TextureHandle _handle);
	...
	///
	BGFX_SHARED_LIB_API FrameBufferHandle createFrameBuffer(
		  uint16_t _width
		, uint16_t _height
		, TextureFormat::Enum _format
	...
	///
	BGFX_SHARED_LIB_API void destroyFrameBuffer(FrameBufferHandle _handle);
	...
	///
	BGFX_SHARED_LIB_API UniformHandle createUniform(const char* _name, UniformType::Enum _type, uint16_t _num = 1);
	...
	///
	BGFX_SHARED_LIB_API void destroyUniform(UniformHandle _handle);
	...
	///
	BGFX_SHARED_LIB_API OcclusionQueryHandle createOcclusionQuery();
	...
	///
	BGFX_SHARED_LIB_API OcclusionQueryResult::Enum getResult(OcclusionQueryHandle _handle);
	...
	///
	BGFX_SHARED_LIB_API void destroyOcclusionQuery(OcclusionQueryHandle _handle);
	...
	///
	BGFX_SHARED_LIB_API void setPaletteColor(uint8_t _index, uint32_t _rgba);
	...
	/// @attention C99 equivalent is `bgfx_set_palette_color`.
	///
	BGFX_SHARED_LIB_API void setPaletteColor(uint8_t _index, float _r, float _g, float _b, float _a);
	...
	/// @attention C99 equivalent is `bgfx_set_palette_color`.
	///
	BGFX_SHARED_LIB_API void setPaletteColor(uint8_t _index, const float _rgba[4]);
	...
	///
	BGFX_SHARED_LIB_API void setViewName(uint8_t _id, const char* _name);
	...
	///
	BGFX_SHARED_LIB_API void setViewRect(uint8_t _id, uint16_t _x, uint16_t _y, uint16_t _width, uint16_t _height);

	/// @attention C99 equivalent is `bgfx_set_view_rect_auto`.
	///
	BGFX_SHARED_LIB_API void setViewRect(uint8_t _id, uint16_t _x, uint16_t _y, BackbufferRatio::Enum _ratio);
	...
	///
	BGFX_SHARED_LIB_API void setViewScissor(
		  uint8_t _id
		, uint16_t _x = 0
		, uint16_t _y = 0
		, uint16_t _width = 0
	...
	///
	BGFX_SHARED_LIB_API void setViewClear(
		  uint8_t _id
		, uint16_t _flags
	...
	///
	BGFX_SHARED_LIB_API void setViewSeq(uint8_t _id, bool _enabled);
	...
	///
	BGFX_SHARED_LIB_API void setViewFrameBuffer(uint8_t _id, FrameBufferHandle _handle);
	...
	///
	BGFX_SHARED_LIB_API void setViewTransform(
		  uint8_t _id
		, const void* _view
		, const void* _projL
	...
	///
	BGFX_SHARED_LIB_API void setViewRemap(uint8_t _id = 0, uint8_t _num = UINT8_MAX, const void* _remap = NULL);
	...
	///
	BGFX_SHARED_LIB_API 	void resetView(uint8_t _id);

	/// Sets debug marker.
	///
	/// @attention C99 equivalent is `bgfx_set_marker`.
	///
	BGFX_SHARED_LIB_API void setMarker(const char* _marker);
	...
	///
	BGFX_SHARED_LIB_API void setState(uint64_t _state, uint32_t _rgba = 0);
	...
	///
	BGFX_SHARED_LIB_API void setCondition(OcclusionQueryHandle _handle, bool _visible);
	...
	///
	BGFX_SHARED_LIB_API void setStencil(uint32_t _fstencil, uint32_t _bstencil = BGFX_STENCIL_NONE);
	...
	///
	BGFX_SHARED_LIB_API uint16_t setScissor(uint16_t _x, uint16_t _y, uint16_t _width, uint16_t _height);
	...
	///
	BGFX_SHARED_LIB_API void setScissor(uint16_t _cache = UINT16_MAX);
	...
	///
	BGFX_SHARED_LIB_API uint32_t setTransform(const void* _mtx, uint16_t _num = 1);
	...
	///
	BGFX_SHARED_LIB_API uint32_t allocTransform(Transform* _transform, uint16_t _num);
	...
	///
	BGFX_SHARED_LIB_API void setTransform(uint32_t _cache, uint16_t _num = 1);
	...
	///
	BGFX_SHARED_LIB_API void setUniform(UniformHandle _handle, const void* _value, uint16_t _num = 1);
	...
	///
	BGFX_SHARED_LIB_API void setIndexBuffer(IndexBufferHandle _handle);
	...
	/// @attention C99 equivalent is `bgfx_set_index_buffer`.
	///
	BGFX_SHARED_LIB_API void setIndexBuffer(IndexBufferHandle _handle, uint32_t _firstIndex, uint32_t _numIndices);
	...
	///
	BGFX_SHARED_LIB_API void setIndexBuffer(DynamicIndexBufferHandle _handle);
	...
	/// @attention C99 equivalent is `bgfx_set_dynamic_index_buffer`.
	///
	BGFX_SHARED_LIB_API void setIndexBuffer(
		  DynamicIndexBufferHandle _handle
	...
	///
	BGFX_SHARED_LIB_API void setIndexBuffer(const TransientIndexBuffer* _tib);
	...
	///
	BGFX_SHARED_LIB_API void setVertexBuffer(VertexBufferHandle _handle);
	...
	/// @attention C99 equivalent is `bgfx_set_vertex_buffer`.
	///
	BGFX_SHARED_LIB_API void setVertexBuffer(VertexBufferHandle _handle, uint32_t _startVertex, uint32_t _numVertices);
	...
	///
	BGFX_SHARED_LIB_API void setVertexBuffer(DynamicVertexBufferHandle _handle);
	...
	/// @attention C99 equivalent is `bgfx_set_dynamic_vertex_buffer`.
	///
	BGFX_SHARED_LIB_API void setVertexBuffer(
		  DynamicVertexBufferHandle _handle
		, uint32_t _startVertex
		, uint32_t _numVertices
		);
	...
	///
	BGFX_SHARED_LIB_API void setVertexBuffer(const TransientVertexBuffer* _tvb);
	...
	///
	BGFX_SHARED_LIB_API void setInstanceDataBuffer(const InstanceDataBuffer* _idb, uint32_t _num = UINT32_MAX);

	/// Set instance data buffer for draw primitive.
	///
	/// @attention C99 equivalent is `bgfx_set_instance_data_from_vertex_buffer`.
	///
	BGFX_SHARED_LIB_API void setInstanceDataBuffer(VertexBufferHandle _handle, uint32_t _startVertex, uint32_t _num);

	/// Set instance data buffer for draw primitive.
	///
	/// @attention C99 equivalent is `bgfx_set_instance_data_from_dynamic_vertex_buffer`.
	///
	BGFX_SHARED_LIB_API void setInstanceDataBuffer(
		  DynamicVertexBufferHandle _handle
		, uint32_t _startVertex
		, uint32_t _num
		);
	...
	///
	BGFX_SHARED_LIB_API void setTexture(
		  uint8_t _stage
	...
	///
	BGFX_SHARED_LIB_API uint32_t touch(uint8_t _id);
	...
	///
	BGFX_SHARED_LIB_API uint32_t submit(
		  uint8_t _id
	...
	///
	BGFX_SHARED_LIB_API void setBuffer(uint8_t _stage, IndexBufferHandle _handle, Access::Enum _access);
	...
	///
	BGFX_SHARED_LIB_API void setBuffer(uint8_t _stage, VertexBufferHandle _handle, Access::Enum _access);
	...
	///
	BGFX_SHARED_LIB_API void setBuffer(uint8_t _stage, DynamicIndexBufferHandle _handle, Access::Enum _access);
	...
	///
	BGFX_SHARED_LIB_API void setBuffer(uint8_t _stage, DynamicVertexBufferHandle _handle, Access::Enum _access);
	...
	///
	BGFX_SHARED_LIB_API void setBuffer(uint8_t _stage, IndirectBufferHandle _handle, Access::Enum _access);
	...
	///
	BGFX_SHARED_LIB_API void setImage(
		  uint8_t _stage
		, UniformHandle _sampler
		, TextureHandle _handle
		, uint8_t _mip
	...
	///
	BGFX_SHARED_LIB_API uint32_t dispatch(
		  uint8_t _id
	...
	///
	BGFX_SHARED_LIB_API void discard();
	...
	///
	BGFX_SHARED_LIB_API void saveScreenShot(const char* _filePath);
