...
///
#define BGFX_FRAMEBUFFER_NONE                UINT32_C(0x00000000) //!<
#define BGFX_FRAMEBUFFER_CUBE_MAP_POSITIVE_X UINT32_C(0x00000000) //!<
#define BGFX_FRAMEBUFFER_CUBE_MAP_NEGATIVE_X UINT32_C(0x00000001) //!<
#define BGFX_FRAMEBUFFER_CUBE_MAP_POSITIVE_Y UINT32_C(0x00000002) //!<
#define BGFX_FRAMEBUFFER_CUBE_MAP_NEGATIVE_Y UINT32_C(0x00000003) //!<
#define BGFX_FRAMEBUFFER_CUBE_MAP_POSITIVE_Z UINT32_C(0x00000004) //!<
#define BGFX_FRAMEBUFFER_CUBE_MAP_NEGATIVE_Z UINT32_C(0x00000005) //!<
#define BGFX_FRAMEBUFFER_CUBE_MAP_SHIFT      0                    //!<
#define BGFX_FRAMEBUFFER_CUBE_MAP_MASK       UINT32_C(0x0000000f) //!<
