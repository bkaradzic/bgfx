...
#define BGFX_BUFFER_BLIT_UNKNOWN                  UINT8_C(0x00)
#define BGFX_BUFFER_BLIT_VERTEX_BUFFER            UINT8_C(0x01)
#define BGFX_BUFFER_BLIT_DYNAMIC_VERTEX_BUFFER    UINT8_C(0x02)
#define BGFX_BUFFER_BLIT_INDEX_BUFFER             UINT8_C(0x03)
#define BGFX_BUFFER_BLIT_DYNAMIC_INDEX_BUFFER     UINT8_C(0x04)
#define BGFX_BUFFER_BLIT_INDIRECT_BUFFER          UINT8_C(0x05)
#define BGFX_BUFFER_BLIT_INSTANCE_BUFFER          UINT8_C(0x06)
#define BGFX_BUFFER_BLIT_COUNT                    UINT8_C(0x07)
