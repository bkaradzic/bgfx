...
#ifndef BGFX_PLATFORM_SUPPORTS_DX9BC
...
#	define BGFX_EMBEDDED_SHADER_DXBC(_renderer, _name) \
	{ _renderer, BGFX_EMBEDDED_SHADER_CONCATENATE(_name, _dxbc), BGFX_EMBEDDED_SHADER_COUNTOF(BGFX_EMBEDDED_SHADER_CONCATENATE(_name, _dxbc) ) },
#endif // BGFX_PLATFORM_SUPPORTS_DXBC

#if BGFX_PLATFORM_SUPPORTS_DX9BC
#	undef  BGFX_EMBEDDED_SHADER_DX9BC
#	define BGFX_EMBEDDED_SHADER_DX9BC(_renderer, _name) \
	{ _renderer, BGFX_EMBEDDED_SHADER_CONCATENATE(_name, _dx9), BGFX_EMBEDDED_SHADER_COUNTOF(BGFX_EMBEDDED_SHADER_CONCATENATE(_name, _dx9) ) },
#endif // BGFX_PLATFORM_SUPPORTS_DX9BC
