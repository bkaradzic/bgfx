...
#define SHADER_UNIFORM_NAME ("_mtl_u")
	...
	struct RendererContextMtl : public RendererContextI
	{
		...
		void createFrameBuffer(FrameBufferHandle _handle, void* _nwh, uint32_t _width, uint32_t _height, TextureFormat::Enum _format, TextureFormat::Enum _depthFormat) override
		{
			...
			fb.m_swapChain->resize(m_frameBuffers[_handle.idx], _width, _height, m_resolution.reset, m_resolution.numBackBuffers);
		}
		...
		void updateResolution(const Resolution& _resolution)
		{
			...
			|| (m_resolution.reset&maskFlags) != (_resolution.reset&maskFlags) )
			{
				...
				m_mainFrameBuffer.m_swapChain->resize(m_mainFrameBuffer, _resolution.width, _resolution.height, _resolution.reset, m_resolution.numBackBuffers);
...
//		murmur.add(m_attrMask, numAttrs);
	...
	void SwapChainMtl::resize(FrameBufferMtl &_frameBuffer, uint32_t _width, uint32_t _height, uint32_t _flags, uint32_t _numBackBuffers)
	{
