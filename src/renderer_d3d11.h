...
namespace bgfx { namespace d3d11
{
	...
	struct TextureD3D11
	{
		...
		void commit(uint32_t _stage, uint32_t _flags, const float _palette[][4], uint16_t _firstLayer = 0, uint16_t _numLayers = UINT16_MAX, uint8_t _firstMip = 0, uint8_t _numMips = UINT8_MAX);
