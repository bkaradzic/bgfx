...
namespace bgfx { namespace d3d12
{
	...
	static const TextureFormatInfo s_textureFormat[] =
	{
		...
		{ DXGI_FORMAT_B4G4R4A4_UNORM,     DXGI_FORMAT_B4G4R4A4_UNORM,        DXGI_FORMAT_UNKNOWN,           DXGI_FORMAT_UNKNOWN,               D3D12_DEFAULT_SHADER_4_COMPONENT_MAPPING            }, // RGBA4
		{ DXGI_FORMAT_B5G5R5A1_UNORM,     DXGI_FORMAT_B5G5R5A1_UNORM,        DXGI_FORMAT_UNKNOWN,           DXGI_FORMAT_UNKNOWN,               D3D12_DEFAULT_SHADER_4_COMPONENT_MAPPING            }, // RGB5A1
...
//		m_gpuHandle.ptr += m_incrementSize;
	...
	void* TextureD3D12::create(const Memory* _mem, uint64_t _flags, uint8_t _skip)
	{
		...
		if (bimg::imageParse(imageContainer, _mem->data, _mem->size) )
		{
			...
			m_srvd.Shader4ComponentMapping = s_textureFormat[m_textureFormat].m_mapping;
