...
#ifndef BGFX_CONFIG_CUDA_INTEROP
#	define BGFX_CONFIG_CUDA_INTEROP 0
#else
# if BGFX_CONFIG_CUDA_INTEROP && !BX_PLATFORM_LINUX
// Only support CUDA interop on Linux for now
# undef BGFX_CONFIG_CUDA_INTEROP
# define BGFX_CONFIG_CUDA_INTEROP 0
#endif
