...
#if BGFX_CONFIG_RENDERER_VULKAN && BGFX_CONFIG_RENDERER_VULKAN < 11
#	undef BGFX_CONFIG_RENDERER_VULKAN
#	define BGFX_CONFIG_RENDERER_VULKAN 10
#endif  // BGFX_CONFIG_RENDERER_VULKAN && BGFX_CONFIG_RENDERER_VULKAN < 11
